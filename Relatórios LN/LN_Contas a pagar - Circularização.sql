...
"  " &
"     CMG101.LOTE                                 LOTE_PGTO,  " &
"     " + Parameters!Compania.Value +  "                                         NUME_CIA  " &
"  " &
"  " &
" FROM       baandb.ttfacp200" + Parameters!Compania.Value +  "  tfacp200  " &
"  " &
" INNER JOIN baandb.ttfacp201" + Parameters!Compania.Value +  "  tfacp201  " &
"         ON tfacp201.t$ttyp = tfacp200.t$ttyp  " &
"        AND tfacp201.t$ninv = tfacp200.t$ninv  " &
"  " &
...
"        AND tccom125.t$cban = tfacp201.t$bank  " &
"  " &
"  LEFT JOIN baandb.ttfcmg011" + Parameters!Compania.Value +  "  tfcmg011b  " &
"         ON tfcmg011b.t$bank = tccom125.t$brch  " &
"  " &
...
"                     a.t$ttyp,  " &
"                     a.t$ninv  " &
"             from baandb.ttfcmg101" + Parameters!Compania.Value +  "  a  " &
"             group by  a.t$ifbp,  " &
"                       a.t$ttyp,  " &
"                       a.t$ninv ) CMG101  " &
"         ON CMG101.t$ifbp = tfacp201.t$ifbp  " &
...
" WHERE tfacp200.t$lino = 0  " &
"   AND Trunc(tfacp200.t$docd) <= :EmissaoAte  " &
"   AND tfacp201.t$pyst$l IN (" + JOIN(Parameters!Situacao.Value, ", ") + ") " &
